...
export default function FeedItem({
    ...
    return (
        <motion.div
            ...
            className={`${cardBg} rounded-2xl ${accentGradient ? 'border-gradient-accent' : `border ${cardBorder}`} ${cardShadow} backdrop-blur-2xl group h-full w-full flex flex-col relative transition-all duration-300 ${!accentGradient ? cardHoverBorder : ''} ${isPressed && theme === 'light' ? 'ring-2 ring-gray-300' : ''}`}
        >
            {(image || video) && (
