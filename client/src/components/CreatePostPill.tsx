...
export default function CreatePostPill({ onClick }: CreatePostPillProps) {
    ...
    return (
        <button
            onClick={onClick}
            className={`fixed bottom-6 md:bottom-8 left-1/2 -translate-x-1/2 z-30 flex items-center gap-2 px-4 md:px-6 py-2.5 md:py-3 rounded-full hover:scale-105 transition-all duration-300 group animate-fade-in-up ${
                isMGT 
